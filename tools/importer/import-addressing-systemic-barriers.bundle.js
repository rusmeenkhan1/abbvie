var CustomImportScript = (() => {
  ...
  // tools/importer/import-addressing-systemic-barriers.js
  var import_addressing_systemic_barriers_exports = {};
  __export(import_addressing_systemic_barriers_exports, {
    default: () => import_addressing_systemic_barriers_default
  });
  ...
  function parse4(element, { document }) {
    ...
    if (!gridRow) {
      const block2 = WebImporter.Blocks.createBlock(document, { name: "columns-impact", cells: [] });
  ...
  var import_addressing_systemic_barriers_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_addressing_systemic_barriers_exports);
})();
